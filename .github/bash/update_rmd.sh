...
# copy
echo "Update files"
cp -r ${down_folder}/vignettes/systemPipeChIPseq.Rmd ${update_dir}
mv ${update_dir}/systemPipeChIPseq.Rmd ${update_dir}/SPchipseq.Rmd
cp -r ${down_folder}/vignettes/bibtex.bib ${update_dir}
echo "done"

# Update skeleton
echo "Update skeleton"
Rscript -e 'SPRthis::skeleton_update("vignettes/SPchipseq.Rmd")'
Rscript -e 'roxygen2::roxygenise()'
Rscript -e 'pkgdown::build_site()'
rm -rf vignettes/SPchipseq_cache
